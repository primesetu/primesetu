    ...
    <div className="fixed inset-0 z-[200] bg-[#FAF7F2] flex items-center justify-center p-6 overflow-hidden">
      ...
      >
        <div className="text-center mb-12">
          <div className="inline-flex w-20 h-20 bg-navy rounded-[2rem] items-center justify-center shadow-2xl shadow-navy/20 mb-6">
            <Terminal className="text-gold w-10 h-10" />
          </div>
          <h1 className="text-4xl font-serif font-black text-navy tracking-tight">PrimeSetu</h1>
          <p className="text-[10px] text-muted font-bold uppercase tracking-[0.4em] mt-2">Native Retail Operating System</p>
        </div>
        ...
        <div className="glass p-10 rounded-[3rem] shadow-2xl border border-white relative">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-navy/40 uppercase tracking-widest ml-2">Terminal Identity</label>
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-navy/40 uppercase tracking-widest ml-2">Access Key</label>
              <div className="relative">
