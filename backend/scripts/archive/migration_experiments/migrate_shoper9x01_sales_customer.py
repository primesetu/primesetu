...
# ============================================================
# SMRITI-OS - Sales & Customer Migration Engine
# Syncs: Customers, SaleTrnHdr, and Payment Details from MSSQL [shoper9x01]
# ============================================================

async def migrate_sales_data(database="shoper9x01"):
    print(f"Starting Sales & Customer sync from MSSQL [{database}]...")
    ...
    try:
        ...
        for table in tables_to_sync:
            ...
            # For large tables, we could use chunks, but 34k is fine for a single fetch in memory
    ...
    try:
        ...
        await pg_conn.close()
        print("Sales & Customer Sync Complete.")
    except Exception as e:
        print(f"PostgreSQL Error: {e}")

if __name__ == "__main__":
    asyncio.run(migrate_sales_data("shoper9x01"))
