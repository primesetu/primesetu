...
class TillSession(Base):
    ...
    opened_by = Column(PGUUID(as_uuid=True), ForeignKey("auth.users.id"), nullable=False)
    closed_by = Column(PGUUID(as_uuid=True), ForeignKey("auth.users.id"), nullable=True)
...
class PosCashTrn(Base):
    ...
    user_id = Column(PGUUID(as_uuid=True), ForeignKey("auth.users.id"), nullable=False)
