...
# ============================================================
# SMRITI-OS - Financial & Taxation Migration Engine
# Syncs: Payment Modes and Tax Configuration from MSSQL [shoper9x01]
# ============================================================

async def migrate_finance(database="shoper9x01"):
    print(f"Starting Financial & Tax metadata sync from MSSQL [{database}]...")
    ...
    try:
        ...
        for table in tables_to_sync:
            ...
            extracted_data[table] = (cols, rows)
    ...
    try:
        ...
        for table, (cols, rows) in extracted_data.items():
            ...
            async with pg_conn.transaction():
                # We use TRUNCATE to ensure we have a fresh copy of config
        ...
        await pg_conn.close()
        print("Financial & Taxation Sync Complete.")
    except Exception as e:
        print(f"PostgreSQL Error: {e}")

if __name__ == "__main__":
    asyncio.run(migrate_finance("shoper9x01"))
