...
async def get_audit_session(
    ...
    from app.domains.inventory.inventory import get_audit_session as get_impl
...
async def add_audit_entry(
    ...
    from app.domains.inventory.inventory import upsert_audit_entry as upsert_impl, AuditItemEntry
...
async def submit_audit(
    ...
    from app.domains.inventory.inventory import finalize_audit_session as finalize_impl
