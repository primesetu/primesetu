...
export default function ItemMaster({ onOpenMatrix }: { onOpenMatrix: (code: string) => void }) {
  return (
    <div className="p-12 h-full flex flex-col gap-8">
      <div className="flex justify-between items-center">
        <div className="relative w-96 group">
          ...
          <input 
            ...
            className="w-full bg-bg-input border-2 border-border rounded-2xl pl-12 pr-4 h-14 text-sm font-black outline-none focus:border-brand-gold shadow-sm text-text-primary" 
          />
        </div>
        <div className="flex gap-4">
          ...
          <button className="flex items-center justify-center w-14 h-14 bg-bg-float border-2 border-border rounded-2xl text-text-secondary hover:border-brand-gold hover:text-text-primary transition-all shadow-sm">
            <Filter size={20}/>
          </button>
          <button className="flex items-center justify-center w-14 h-14 bg-bg-float border-2 border-border rounded-2xl text-text-secondary hover:border-brand-gold hover:text-text-primary transition-all shadow-sm">
            <Download size={20}/>
      ...
      <div className="flex-1 bg-bg-elevated/40 rounded-[3rem] shadow-xl border border-border overflow-hidden flex flex-col">
